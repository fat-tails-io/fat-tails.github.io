---
title: Get All Issue Type Schemes
...
// -----------------------------------------------------------------------------
// JiraGetIssuetypescheme
// Description: Returns a [paginated](#pagination) list of issue type schemes.

Only issue type schemes used in classic projects are returned.

**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/issuetypescheme
// Create this with query name: JiraGetIssuetypescheme
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional orderBy as text, optional expand as text, optional queryString as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/issuetypescheme",
