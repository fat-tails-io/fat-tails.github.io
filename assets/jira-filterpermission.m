 ...
 *  filters shared with a public project.
 *  filters shared with the public.
// API Endpoint: GET /rest/api/3/filter/{id}/permission/{permissionId}
// Create this with query name: JiraGetFilterPermission
// -----------------------------------------------------------------------------
(id as text, permissionId as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/filter/" & id & "/permission/" & permissionId & "",
    FullUrl = BaseUrl,
