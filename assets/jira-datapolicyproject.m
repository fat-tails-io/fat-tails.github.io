...
// -----------------------------------------------------------------------------
// JiraGetDataPolicyProject
// Description: Returns data policies for the projects specified in the request.
// API Endpoint: GET /rest/api/3/data-policy/project
// Create this with query name: JiraGetDataPolicyProject
// -----------------------------------------------------------------------------
(optional ids as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ids = if ids = null then null else ids,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/data-policy/project",
