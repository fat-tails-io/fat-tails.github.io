...
// Description: |-
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/plans/plan/{planId}
// Create this with query name: JiraGetPlansPlan
// -----------------------------------------------------------------------------
(planId as text, optional useGroupId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            useGroupId = if useGroupId = null then null else useGroupId,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/plans/plan/" & planId & "",
