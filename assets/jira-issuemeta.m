...
// Create this with query name: JiraGetIssueCreatemeta
// -----------------------------------------------------------------------------
(optional projectIds as text, optional projectKeys as text, optional issuetypeIds as text, optional issuetypeNames as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            projectIds = if projectIds = null then null else projectIds,
            projectKeys = if projectKeys = null then null else projectKeys,
            issuetypeIds = if issuetypeIds = null then null else issuetypeIds,
            issuetypeNames = if issuetypeNames = null then null else issuetypeNames,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/issue/createmeta",
