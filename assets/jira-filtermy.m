...
// -----------------------------------------------------------------------------
(optional expand as text, optional includeFavourites as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            includeFavourites = if includeFavourites = null then null else includeFavourites,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/filter/my",
