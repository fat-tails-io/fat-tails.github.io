---
title: Get Issue Type Screen Scheme Items
...
// -----------------------------------------------------------------------------
// JiraGetIssuetypescreenschemeMapping
// Description: Returns a [paginated](#pagination) list of issue type screen scheme items.

Only issue type screen schemes used in classic projects are returned.

**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/issuetypescreenscheme/mapping
// Create this with query name: JiraGetIssuetypescreenschemeMapping
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional issueTypeScreenSchemeId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            issueTypeScreenSchemeId = if issueTypeScreenSchemeId = null then null else issueTypeScreenSchemeId,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/issuetypescreenscheme/mapping",
