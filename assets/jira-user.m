...
// Description: |-
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/user
// Create this with query name: JiraGetUser
// -----------------------------------------------------------------------------
(optional accountId as text, optional username as text, optional key as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/user",
