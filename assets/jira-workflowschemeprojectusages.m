...
// -----------------------------------------------------------------------------
// JiraGetWorkflowschemeProjectusages
// Description: Returns a page of projects using a given workflow scheme.
// API Endpoint: GET /rest/api/3/workflowscheme/{workflowSchemeId}/projectUsages
// Create this with query name: JiraGetWorkflowschemeProjectusages
// -----------------------------------------------------------------------------
(workflowSchemeId as text, optional nextPageToken as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflowscheme/" & workflowSchemeId & "/projectUsages",
