...
// -----------------------------------------------------------------------------
(optional projectId as text, optional templateKey as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            templateKey = if templateKey = null then null else templateKey,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/project-template/live-template",
