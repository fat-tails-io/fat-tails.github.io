...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional projectId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/issuesecurityschemes/search",
