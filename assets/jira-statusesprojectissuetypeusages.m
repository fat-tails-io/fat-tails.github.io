---
title: Get Issue Type Usages By Status And Project
...
// -----------------------------------------------------------------------------
// JiraGetStatusesProjectIssuetypeusages
// Description: Returns a page of issue types in a project using a given status.
// API Endpoint: GET /rest/api/3/statuses/{statusId}/project/{projectId}/issueTypeUsages
// Create this with query name: JiraGetStatusesProjectIssuetypeusages
// -----------------------------------------------------------------------------
(statusId as text, projectId as text, optional nextPageToken as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/statuses/" & statusId & "/project/" & projectId & "/issueTypeUsages",
