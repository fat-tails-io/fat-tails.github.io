...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional query as text, optional expand as text, optional orderBy as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/field/search/trashed",
