---
title: Get Issue Types In A Project That Are Using A Given Workflow
...
// -----------------------------------------------------------------------------
// JiraGetWorkflowProjectIssuetypeusages
// Description: Returns a page of issue types using a given workflow within a project.
// API Endpoint: GET /rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages
// Create this with query name: JiraGetWorkflowProjectIssuetypeusages
// -----------------------------------------------------------------------------
(workflowId as text, projectId as text, optional nextPageToken as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflow/" & workflowId & "/project/" & projectId & "/issueTypeUsages",
