...
// -----------------------------------------------------------------------------
(optional groupname as text, optional groupId as text, optional includeInactiveUsers as text, optional startAt as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            includeInactiveUsers = if includeInactiveUsers = null then null else includeInactiveUsers,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/group/member",
