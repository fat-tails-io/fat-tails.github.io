...
// Description: |-
  ...
  **[Permissions](#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/group/bulk
// Create this with query name: JiraGetGroupBulk
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional groupId as text, optional groupName as text, optional accessType as text, optional applicationKey as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            accessType = if accessType = null then null else accessType,
            applicationKey = if applicationKey = null then null else applicationKey,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/group/bulk",
