...
// -----------------------------------------------------------------------------
// JiraGetWorkflowschemeWorkflow
// Description: Returns the workflow-issue type mappings for a workflow scheme.

**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/workflowscheme/{id}/workflow
// Create this with query name: JiraGetWorkflowschemeWorkflow
// -----------------------------------------------------------------------------
(id as text, optional workflowName as text, optional returnDraftIfExists as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            returnDraftIfExists = if returnDraftIfExists = null then null else returnDraftIfExists,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflowscheme/" & id & "/workflow",
