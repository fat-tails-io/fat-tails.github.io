...
// API Endpoint: GET /rest/api/3/search
// Create this with query name: JiraGetSearch
// -----------------------------------------------------------------------------
(optional jql as text, optional startAt as text, optional maxResults as text, optional validateQuery as text, optional fields as text, optional expand as text, optional properties as text, optional fieldsByKeys as text, optional failFast as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            validateQuery = if validateQuery = null then null else validateQuery,
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/search",
