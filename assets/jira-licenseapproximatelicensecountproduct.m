---
title: Get Approximate Application License Count
...
// -----------------------------------------------------------------------------
// JiraGetLicenseApproximatelicensecountProduct
// Description: Returns the total approximate number of user accounts for a single Jira license. Note that this information is cached with a 7-day lifecycle and could be stale at the time of call.

**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/license/approximateLicenseCount/product/{applicationKey}
// Create this with query name: JiraGetLicenseApproximatelicensecountProduct
// -----------------------------------------------------------------------------
(applicationKey as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/license/approximateLicenseCount/product/" & applicationKey & "",
    FullUrl = BaseUrl,
