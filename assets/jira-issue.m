...
// Create this with query name: JiraGetIssue
// -----------------------------------------------------------------------------
(issueIdOrKey as text, optional fields as text, optional fieldsByKeys as text, optional expand as text, optional properties as text, optional updateHistory as text, optional failFast as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            updateHistory = if updateHistory = null then null else updateHistory,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/issue/" & issueIdOrKey & "",
