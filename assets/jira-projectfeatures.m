...
// -----------------------------------------------------------------------------
// JiraGetProjectFeatures
// Description: Returns the list of features for a project.
// API Endpoint: GET /rest/api/3/project/{projectIdOrKey}/features
// Create this with query name: JiraGetProjectFeatures
// -----------------------------------------------------------------------------
...
let
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/project/" & projectIdOrKey & "/features",
    FullUrl = BaseUrl,
