...
// -----------------------------------------------------------------------------
// JiraGetStatusesProjectusages
// Description: Returns a page of projects using a given status.
// API Endpoint: GET /rest/api/3/statuses/{statusId}/projectUsages
// Create this with query name: JiraGetStatusesProjectusages
// -----------------------------------------------------------------------------
...
let
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/statuses/" & statusId & "/projectUsages",
