...
**[Permissions](#permissions) required:** None.
// API Endpoint: GET /rest/api/3/mypreferences/locale
// Create this with query name: JiraGetMypreferencesLocale
// -----------------------------------------------------------------------------
() =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/mypreferences/locale",
    FullUrl = BaseUrl,
