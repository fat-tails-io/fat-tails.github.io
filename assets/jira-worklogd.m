 ...
 *  the worklog is set as *Viewable by All Users*.
 *  the user is a member of a project role or group with permission to view the worklog.
// API Endpoint: GET /rest/api/3/worklog/updated
// Create this with query name: JiraGetWorklogUpdated
// -----------------------------------------------------------------------------
(optional since as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            since = if since = null then null else since,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/worklog/updated",
