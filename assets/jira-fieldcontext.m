...
// Description: |-
  ...
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). *Edit Workflow* [edit workflow permission](https://support.atlassian.com/jira-cloud-administration/docs/permissions-for-company-managed-projects/#Edit-Workflows)
// API Endpoint: GET /rest/api/3/field/{fieldId}/context
// Create this with query name: JiraGetFieldContext
// -----------------------------------------------------------------------------
(fieldId as text, optional isAnyIssueType as text, optional isGlobalContext as text, optional contextId as text, optional startAt as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            isAnyIssueType = if isAnyIssueType = null then null else isAnyIssueType,
            isGlobalContext = if isGlobalContext = null then null else isGlobalContext,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/field/" & fieldId & "/context",
