...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional fieldConfigurationSchemeId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            fieldConfigurationSchemeId = if fieldConfigurationSchemeId = null then null else fieldConfigurationSchemeId,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/fieldconfigurationscheme/mapping",
