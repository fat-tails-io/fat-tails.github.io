...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional schemeId as text, optional onlyDefault as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/issuesecurityschemes/level",
