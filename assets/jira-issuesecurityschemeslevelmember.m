...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional schemeId as text, optional levelId as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            levelId = if levelId = null then null else levelId,
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/issuesecurityschemes/level/member",
