...
// API Endpoint: GET /rest/api/3/bulk/issues/transition
// Create this with query name: JiraGetBulkIssuesTransition
// -----------------------------------------------------------------------------
(issueIdsOrKeys as text, optional endingBefore as text, optional startingAfter as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/bulk/issues/transition",
