...
// -----------------------------------------------------------------------------
// JiraGetStatusesWorkflowusages
// Description: Returns a page of workflows using a given status.
// API Endpoint: GET /rest/api/3/statuses/{statusId}/workflowUsages
// Create this with query name: JiraGetStatusesWorkflowusages
// -----------------------------------------------------------------------------
(statusId as text, optional nextPageToken as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/statuses/" & statusId & "/workflowUsages",
