...
// -----------------------------------------------------------------------------
// JiraGetLicenseApproximatelicensecount
// Description: |-
  Returns the approximate number of user accounts across all Jira licenses. Note that this information is cached with a 7-day lifecycle and could be stale at the time of call.
  
  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/license/approximateLicenseCount
// Create this with query name: JiraGetLicenseApproximatelicensecount
// -----------------------------------------------------------------------------
() =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/license/approximateLicenseCount",
    FullUrl = BaseUrl,
