...
// Description: |-
  ...
  **[Permissions](#permissions) required:** *Browse Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
// API Endpoint: GET /rest/api/3/project/{projectIdOrKey}/components
// Create this with query name: JiraGetProjectComponents
// -----------------------------------------------------------------------------
(projectIdOrKey as text, optional componentSource as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/project/" & projectIdOrKey & "/components",
