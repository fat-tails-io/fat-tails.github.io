---
title: Get Project Role For Project
...
**[Permissions](#permissions) required:** *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project or *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/project/{projectIdOrKey}/role/{id}
// Create this with query name: JiraGetProjectRole
// -----------------------------------------------------------------------------
(projectIdOrKey as text, id as text, optional excludeInactiveUsers as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            excludeInactiveUsers = if excludeInactiveUsers = null then null else excludeInactiveUsers,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/project/" & projectIdOrKey & "/role/" & id & "",
