...
// Description: |-
  ...
  **[Permissions](#permissions) required:** Permission to access Jira.
// API Endpoint: GET /rest/api/3/mypreferences
// Create this with query name: JiraGetMypreferences
// -----------------------------------------------------------------------------
(key as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/mypreferences",
