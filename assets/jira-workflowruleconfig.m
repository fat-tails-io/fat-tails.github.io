...
// Description: |-
  ...
  **[Permissions](#permissions) required:** Only [Connect](https://developer.atlassian.com/cloud/jira/platform/index/#connect-apps) or [Forge](https://developer.atlassian.com/cloud/jira/platform/index/#forge-apps) apps can use this operation.
// API Endpoint: GET /rest/api/3/workflow/rule/config
// Create this with query name: JiraGetWorkflowRuleConfig
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, types as text, optional keys as text, optional workflowNames as text, optional withTags as text, optional draft as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            workflowNames = if workflowNames = null then null else workflowNames,
            withTags = if withTags = null then null else withTags,
            draft = if draft = null then null else draft,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflow/rule/config",
