...
// -----------------------------------------------------------------------------
// JiraGetUniversal_AvatarTypeOwner
// Description: Returns the system and custom avatars for a project, issue type or priority.
 ...
 *  for system avatars, none.
 *  for priority avatars, none.
// API Endpoint: GET /rest/api/3/universal_avatar/type/{type}/owner/{entityId}
// Create this with query name: JiraGetUniversal_AvatarTypeOwner
// -----------------------------------------------------------------------------
(type as text, entityId as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/universal_avatar/type/" & type & "/owner/" & entityId & "",
    FullUrl = BaseUrl,
