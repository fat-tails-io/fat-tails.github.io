...
endpoint: /rest/api/3/issuesecurityschemes/project
method: GET
published: false
---

// -----------------------------------------------------------------------------
// JiraGetIssuesecurityschemesProject
// Description: |-
  Returns a [paginated](#pagination) mapping of projects that are using security schemes. You can provide either one or multiple security scheme IDs or project IDs to filter by. If you don't provide any, this will return a list of all mappings. Only issue security schemes in the context of classic projects are supported. **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg). with automatic pagination handling
// API Endpoint: GET /rest/api/3/issuesecurityschemes/project
// Create this with query name: JiraGetIssuesecurityschemesProject
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional issueSecuritySchemeId as text, optional projectId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            issueSecuritySchemeId = if issueSecuritySchemeId = null then null else issueSecuritySchemeId,
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/issuesecurityschemes/project",
