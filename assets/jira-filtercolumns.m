...
// Description: |-
  ...
  **[Permissions](#permissions) required:** None, however, column details are only returned for:
   ...
   *  filters shared with a public project.
   *  filters shared with the public.
// API Endpoint: GET /rest/api/3/filter/{id}/columns
// Create this with query name: JiraGetFilterColumns
// -----------------------------------------------------------------------------
(id as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/filter/" & id & "/columns",
    FullUrl = BaseUrl,
