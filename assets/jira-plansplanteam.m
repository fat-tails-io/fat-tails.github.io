...
// -----------------------------------------------------------------------------
(planId as text, optional cursor as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            cursor = if cursor = null then null else cursor,
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/plans/plan/" & planId & "/team",
