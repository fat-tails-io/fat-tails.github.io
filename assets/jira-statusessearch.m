...
// -----------------------------------------------------------------------------
(optional projectId as text, optional startAt as text, optional maxResults as text, optional searchString as text, optional statusCategory as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            searchString = if searchString = null then null else searchString,
            statusCategory = if statusCategory = null then null else statusCategory,
        ],
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/statuses/search",
