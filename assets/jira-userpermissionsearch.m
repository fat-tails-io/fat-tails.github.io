 ...
 *  *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg), to get users for any project.
 *  *Administer Projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for a project, to get users for that project. with automatic pagination handling
// API Endpoint: GET /rest/api/3/user/permission/search
// Create this with query name: JiraGetUserPermissionSearch
// -----------------------------------------------------------------------------
(optional query as text, optional username as text, optional accountId as text, permissions as text, optional issueKey as text, optional projectKey as text, optional startAt as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/user/permission/search",
