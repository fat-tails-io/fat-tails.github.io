---
title: Get Workflow Schemes Which Are Using A Given Workflow
description: Returns a page of workflow schemes using a given workflow.
endpoint: /rest/api/3/workflow/{workflowId}/workflowSchemes
method: GET
published: false
---

// -----------------------------------------------------------------------------
// JiraGetWorkflowWorkflowschemes
// Description: Returns a page of workflow schemes using a given workflow.
// API Endpoint: GET /rest/api/3/workflow/{workflowId}/workflowSchemes
// Create this with query name: JiraGetWorkflowWorkflowschemes
// -----------------------------------------------------------------------------
(workflowId as text, optional nextPageToken as text, optional maxResults as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflow/" & workflowId & "/workflowSchemes",
