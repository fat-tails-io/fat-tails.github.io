---
title: Get Field Reference Data (Get)
...
// API Endpoint: GET /rest/api/3/jql/autocompletedata
// Create this with query name: JiraGetJqlAutocompletedata
// -----------------------------------------------------------------------------
() =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/jql/autocompletedata",
    FullUrl = BaseUrl,
