...
// -----------------------------------------------------------------------------
// JiraGetWorkflowProjectusages
// Description: Returns a page of projects using a given workflow.
// API Endpoint: GET /rest/api/3/workflow/{workflowId}/projectUsages
// Create this with query name: JiraGetWorkflowProjectusages
// -----------------------------------------------------------------------------
...
let
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/workflow/" & workflowId & "/projectUsages",
