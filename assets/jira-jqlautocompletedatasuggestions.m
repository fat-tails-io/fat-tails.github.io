...
// -----------------------------------------------------------------------------
(optional fieldName as text, optional fieldValue as text, optional predicateName as text, optional predicateValue as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            fieldName = if fieldName = null then null else fieldName,
            fieldValue = if fieldValue = null then null else fieldValue,
            predicateName = if predicateName = null then null else predicateName,
            predicateValue = if predicateValue = null then null else predicateValue,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/jql/autocompletedata/suggestions",
