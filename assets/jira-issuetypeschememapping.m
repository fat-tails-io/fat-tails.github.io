---
title: Get Issue Type Scheme Items
...
// -----------------------------------------------------------------------------
// JiraGetIssuetypeschemeMapping
// Description: Returns a [paginated](#pagination) list of issue type scheme items.

Only issue type scheme items used in classic projects are returned.

**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
// API Endpoint: GET /rest/api/3/issuetypescheme/mapping
// Create this with query name: JiraGetIssuetypeschemeMapping
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional issueTypeSchemeId as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            issueTypeSchemeId = if issueTypeSchemeId = null then null else issueTypeSchemeId,
        ],
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/issuetypescheme/mapping",
