...
// -----------------------------------------------------------------------------
// JiraGetDashboardItemsProperties
// Description: Returns the key and value of a dashboard item property.
...
**[Permissions](#permissions) required:** The user must have read permission of the dashboard or have the dashboard shared with them.
// API Endpoint: GET /rest/api/3/dashboard/{dashboardId}/items/{itemId}/properties/{propertyKey}
// Create this with query name: JiraGetDashboardItemsProperties
// -----------------------------------------------------------------------------
(dashboardId as text, itemId as text, propertyKey as text) =>
let
    // CONFIGURATION setup. 
    ...
    // Build URL
    BaseUrl = JiraBaseUrl & "/rest/api/3/dashboard/" & dashboardId & "/items/" & itemId & "/properties/" & propertyKey & "",
    FullUrl = BaseUrl,
