...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional id as text, optional projectId as text, optional priorityName as text, optional onlyDefault as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            priorityName = if priorityName = null then null else priorityName,
