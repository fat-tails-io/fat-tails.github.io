...
// -----------------------------------------------------------------------------
(issueSecuritySchemeId as text, optional startAt as text, optional maxResults as text, optional issueSecurityLevelId as text, optional expand as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            issueSecurityLevelId = if issueSecurityLevelId = null then null else issueSecurityLevelId,
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/issuesecurityschemes/" & issueSecuritySchemeId & "/members",
