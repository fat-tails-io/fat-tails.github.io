...
description: This will be removed on [June 1, 2026](https://developer.atlassian.com/cloud/jira/platform/changelog/#CHANGE-2569); use [Search workflows](#api-rest-api-3-workflows-search-get) instead.
...
// API Endpoint: GET /rest/api/3/workflow/search
// Create this with query name: JiraGetWorkflowSearch
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional workflowName as text, optional expand as text, optional queryString as text, optional orderBy as text, optional isActive as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            workflowName = if workflowName = null then null else workflowName,
