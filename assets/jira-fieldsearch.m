...
// -----------------------------------------------------------------------------
(optional startAt as text, optional maxResults as text, optional type as text, optional id as text, optional query as text, optional orderBy as text, optional expand as text, optional projectIds as text) =>
let
    // CONFIGURATION setup. 
    ...
    QueryParams = [
            ...
            type = if type = null then null else type,
        ...
        CleanQueryParams = Record.SelectFields(
            ...
            BaseUrl = JiraBaseUrl & "/rest/api/3/field/search",
