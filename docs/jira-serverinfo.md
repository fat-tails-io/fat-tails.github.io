...
1. **Load the M code**: Use the function `JiraGetServerinfo` from [jira-serverinfo.m](../assets/jira-serverinfo.m)
...
---
*This documentation corresponds to the Jira API endpoint: `/rest/api/3/serverInfo`*
