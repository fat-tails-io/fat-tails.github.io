...
1. **Load the M code**: Use the function `JiraGetConfigurationTimetracking` from [jira-configurationtimetracking.m](../assets/jira-configurationtimetracking.m)
...
---
*This documentation corresponds to the Jira API endpoint: `/rest/api/3/configuration/timetracking`*
