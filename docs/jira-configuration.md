...
1. **Load the M code**: Use the function `JiraGetConfiguration` from [jira-configuration.m](../assets/jira-configuration.m)
...
---
*This documentation corresponds to the Jira API endpoint: `/rest/api/3/configuration`*
