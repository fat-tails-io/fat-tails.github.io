...
1. **Load the M code**: Use the function `JiraGetDataPolicy` from [jira-datapolicy.m](../assets/jira-datapolicy.m)
...
---
*This documentation corresponds to the Jira API endpoint: `/rest/api/3/data-policy`*
