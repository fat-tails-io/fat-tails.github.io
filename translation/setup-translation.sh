...
echo ""
echo "Next steps:"
echo "1. Get your DeepL API key:"
echo "   - Go to: https://www.deepl.com/pro-api"
echo "   - Sign up for a free account (or use existing)"
echo "   - Copy your API key from the dashboard"
echo ""
echo "2. Add DEEPL_API_KEY to your repository secrets:"
echo "   - Go to your GitHub repository"
echo "   - Click Settings → Secrets and variables → Actions"
echo "   - Click 'New repository secret'"
echo "   - Name: DEEPL_API_KEY"
echo "   - Value: [paste your API key]"
echo "   - Click 'Add secret'"
echo ""
echo "3. Test the translation workflow:"
...
echo ""
echo "4. Monitor translation quality:"
...
echo ""
echo "5. Configure Jekyll for multilingual support:"
